...
#=============================================================================
def get_R( sst_in, pnts, vals ):

    Rw_0 = griddata( pnts, vals[0], sst_in, fill_value=0.0 )[0]
    Rw_B = griddata( pnts, vals[1], sst_in, fill_value=0.0 )[0]
    Rw_T = griddata( pnts, vals[2], sst_in, fill_value=0.0 )[0]
    Rc_0 = griddata( pnts, vals[3], sst_in, fill_value=0.0 )[0]
    Rc_B = griddata( pnts, vals[4], sst_in, fill_value=0.0 )[0]
    Rc_T = griddata( pnts, vals[5], sst_in, fill_value=0.0 )[0]
    return np.array( [[ Rw_0, Rw_B, Rw_T ], [Rc_0, Rc_B, Rc_T]] )



def myfunc( sst_in, qq_TI_c, aa_w, pnts, vals, verbose, outfile ):
